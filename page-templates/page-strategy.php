            ...
            <div class="strategy-status__risk-card" id="status-risk">
                ...
                <div class="strategy-status__risk-list">
                    <div class="strategy-status__risk-item">
                        <img src="<?php echo YANI_THEME_URI; ?>/assets/images/strategy/Group 321.png" alt="">
    ...
    <section class="strategy-next" id="strategy-next">
        <div class="container">
            <div class="strategy-next__content">
                ...
                <!-- Left: Number + Title inline -->
                <div class="strategy-next__header">
                    <span class="strategy-next__number">10</span>
                    <h2 class="strategy-next__title">BƯỚC<br>TIẾP THEO</h2>
                </div>
            ...
            <p class="strategy-next__note">Nếu doanh nghiệp cần điều chỉnh phạm vi hoặc nhận bản đề xuất chi tiết hơn theo ngành, Yani Content sẵn sàng trao đổi thêm.</p>
        </div>
    </section>
